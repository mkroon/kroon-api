# Kroon API OpenAPI Specification
[![Build Status](https://travis-ci.org/mkroon/kroon-api.svg?branch=master)](https://travis-ci.org/mkroon/kroon-api)
...
6. If you did everything correct, https://mkroon.github.io/kroon-api/ will lead to your new docs
...
- Documentation(ReDoc): https://mkroon.github.io/kroon-api/
- SwaggerUI: https://mkroon.github.io/kroon-api/swagger-ui/
- Look full spec:
    + JSON https://mkroon.github.io/kroon-api/swagger.json
    + YAML https://mkroon.github.io/kroon-api/swagger.yaml
- Preview spec version for branch `[branch]`: https://mkroon.github.io/kroon-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://mkroon.github.io/kroon-api/ with url from the message: `Server started <url>`
